...
## Version 1.1.1 — Status Patch

**Project:** Tiwakings Craftworld Industries (TCIndustries)  
**Document Title:** Master Game Design Document  
**Version:** 1.1.1 — Status Patch  
**Patch Date:** 2026-08-25  
**Author:** OpenAI GPT-5.6 Luna  
**Document Purpose:** Working canonical design reference for TCIndustries. This patch applies human authority rulings from the Authority & Provenance Reconciliation Matrix. No new game-design decisions or mechanical content are introduced.  
**Authority Statement:** This document is the current working canonical design reference for TCIndustries. Status tags are authoritative. No status is silently promoted. Derived constraints are explicitly distinguished from human-locked decisions. Human confirmation of the HUMAN-LOCKED set is recorded in this patch.  
...
- Status baseline: `TCIndustries_Master_GDD_v1.1_Canonical_Baseline.md`
- Authority matrix: `TCIndustries_Authority_Provenance_Reconciliation_Matrix.md`
- Human rulings applied: 2026-08-25
...
| Version | 1.1.1 — Status Patch |
| Status | Working Canonical Reference (human authority rulings applied) |
...
| Prior Version | 1.1 — Canonical Baseline |
| Controlling Audit | TCIndustries_Master_GDD_v1.0_Canonical_Audit.md |
| Authority Matrix | TCIndustries_Authority_Provenance_Reconciliation_Matrix.md |
...
**Status: LOCKED**  
**Authority:** HUMAN-LOCKED (confirmed 2026-08-25). Principle only; implementation details remain open.
...
**Status: LOCKED**  
**Authority:** HUMAN-LOCKED (confirmed 2026-08-25). Principle only; attribute/progression implementation remains open.
...
## PLR-003 — Ownership
**Status: LOCKED**  
**Authority:** HUMAN-LOCKED (confirmed 2026-08-25). Principle of meaningful persistent ownership only. Tradability, soul-binding, taxation, decay, and transfer mechanics remain open / non-canonical unless separately decided.
...
Ownership systems must include safeguards against fraud, abandoned assets, and exploitative transfer mechanics. (See SAFE-001.)
...
**Status: LOCKED**  
**Authority:** HUMAN-LOCKED (confirmed 2026-08-25). Principle only. Quality tiers, experimentation model, Exceptional outcomes, and factory quality rules remain open / non-canonical unless separately decided.
...
**Status: PROPOSED**  
**Human ruling (2026-08-25):** Demoted from DERIVED CONSTRAINT. Interdependence (PIL-003) does not logically entail a particular character-level mastery limitation. Mechanism for achieving specialisation remains unresolved.

Crafting depth should reinforce specialisation rather than allow one character to efficiently dominate all high-value production. This remains a design objective to be tested in the Economic Interdependence Core; it is not a locked constraint.
...
**Status: PROPOSED**  
**Human ruling (2026-08-25):** Demoted from DERIVED CONSTRAINT. LOOP-002 locks meaningful long-term non-combat viability; it does not independently lock a requirement for multiple simultaneously viable paths.

Multiple long-term identities and careers should remain viable. This is a design proposition consistent with sandbox philosophy; it is not a derived constraint of LOOP-002.
...
**Status: LOCKED**  
**Authority:** HUMAN-LOCKED (confirmed 2026-08-25). Principle only. Specific mechanisms (soul-binding, trade restrictions, transfer rules, etc.) remain open / non-canonical unless separately decided.
...
| WRLD-001 | Persistent shared world | LOCKED | HUMAN-LOCKED (confirmed 2026-08-25) | World, ownership | Core — principle only |
| PLR-001 | Persistent character identity | LOCKED | HUMAN-LOCKED (confirmed 2026-08-25) | Player systems | Core — principle only |
| PLR-003 | Persistent ownership | LOCKED | HUMAN-LOCKED (confirmed 2026-08-25) | Buildings, items | Core — principle only |
...
| CRFT-001 | Differentiated products | LOCKED | HUMAN-LOCKED (confirmed 2026-08-25) | Resources, skills | Core — principle only |
...
| PROG-002 | Multiple viable paths | PROPOSED | Human ruling 2026-08-25: demoted; stronger than LOOP-002 | Progression | Demoted in v1.1.1 |
| CRFT-006 | No Instant Mastery of Everything | PROPOSED | Human ruling 2026-08-25: demoted; mechanism unresolved | Crafting | Demoted in v1.1.1 |
| EMRG-001 | Conditions for emergence | LOCKED | Explicit | All systems | Core |
| SAFE-001 | Ownership/transfer safeguards | LOCKED | HUMAN-LOCKED (confirmed 2026-08-25) | Ownership | Core — principle only |
...
## v1.1.1 Status Patch — Change Scope
...
| ID | Ruling | Result |
|---|---|---|
| CRFT-006 | Demote from DERIVED CONSTRAINT | **PROPOSED** — specialisation mechanism unresolved |
| PROG-002 | Demote from DERIVED CONSTRAINT | **PROPOSED** — stronger than LOOP-002 requires |
| WRLD-001 | Confirm as HUMAN-LOCKED | LOCKED — principle only |
| PLR-001 | Confirm as HUMAN-LOCKED | LOCKED — principle only |
| PLR-003 | Confirm as HUMAN-LOCKED | LOCKED — principle only |
| CRFT-001 | Confirm as HUMAN-LOCKED | LOCKED — principle only |
| SAFE-001 | Confirm as HUMAN-LOCKED | LOCKED — principle only |
| Matrix §5 boundary | Confirm | Older mechanical proposals remain **NOT CANONICAL** |

### Retained DERIVED CONSTRAINTS (unchanged)

| ID | Rule | Derives from |
|---|---|---|
...
### Historical non-canonical boundary (confirmed)

The following remain **NOT CANONICAL** unless explicitly promoted by a future human decision:
...
### Document status lineage

- v1.0: Consolidation Candidate / Working Reference
- v1.1: Working Canonical Reference (status/authority pass complete)
- v1.1.1: Working Canonical Reference (human authority rulings applied)
- Fully frozen project canon: still requires prototype evidence reconciliation before major system design is treated as validated

## Inherited from prior versions

1. **LOCKED core vision and pillars** retained and now human-confirmed where previously under authority review.
...
4. **Prototype references** remain PROTOTYPE/ASSUMPTION. No prototype was inspected during consolidation or status passes.
...
## Remaining open design decisions (not status issues)

1. Final specialisation budget / skill-cap model (structural meaning of “specialist”) — **PROPOSED / TBD**
...
**End of Master GDD v1.1.1 — Status Patch**

This document is the current working canonical design reference. Future system-specific specifications should build upon, and remain consistent with, the LOCKED principles (including human-confirmed items), DERIVED CONSTRAINTS, and status discipline established here. No further LLM consolidation of the Master GDD should occur.

**Next operations:** Prototype Evidence Reconciliation (when available), then Economic Interdependence Core package (Specialisation ↔ Resources ↔ Crafting ↔ Manufacturing ↔ NPC substitution ↔ Demand), expressed as Principle → Constraint → Invariant → Failure Condition → Test.
